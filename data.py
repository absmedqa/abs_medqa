...
triples_to_take=512 ### change this to specify the number of triples that will be passed into the GNN
            ...
            for ques in data_set:
                for q in ques['qas']:
                    ...
                    for i in range(triples_to_take):
                        if i >= len(ques["kg triple"]):
                            triples.append(["_NAF_H", "_NAF_R", "_NAF_T"])
                        else:
                            triples.append(ques["kg triple"][i])
                    self.data.append({
        ...
        if self.load and os.path.exists(preprocessed_path) and False:
            ...
            for d in self.data:
                ...
                for trip in d["triples"]:
                    h, r, t = trip
                    kg_input.append([vocab_ent[h], vocab_relation[r],vocab_ent[t]])
