...
class BartEncoder(nn.Module):
    ...
    def __init__(self, config: BartConfig, embed_tokens, hidden_size=None, entity_vocab=None, relation_vocab=None, t_embed=None):
        ...
        # Linear concat
        self.hidden_size = config.hidden_size #config.hidden_size 1024 /home/Abstractive_Qa/KG_Bart/bart
        ...
        self.l_layer_attn_flow = nn.Linear(config.hidden_size*3, config.hidden_size)
    ...
    def forward(
        ...
        if _method == "att":
            x = self.att_flow_layer(x, triple_emb)
        else:
